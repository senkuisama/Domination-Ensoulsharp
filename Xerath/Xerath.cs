namespace EnsoulSharp.Xerath
{
    ...
    internal class Xerath
    {
        ...
        public static void OnLoad()
        {
            ...
            Q.SetSkillshot(0.60f, 90f, float.MaxValue, false, false, SkillshotType.Line);
            ...
            var MyMenu = new Menu(ObjectManager.Player.CharacterName, "(Exory Prediction).Xerath", true);
            var Orbwalking = new Menu("_OrbWalking", "OrbWalking @@");
            new Orbwalking.Orbwalker(Orbwalking);
            MyMenu.Add(Orbwalking);
        ...
        private static FSpred.Prediction.CollisionableObjects[] CollisionableObjects = new FSpred.Prediction.CollisionableObjects[]
        {
        ...
        private static void OnDraw(EventArgs args)
        {
            ...
            if(target != null)
            {
                ...
                {
                    Render.Circle.DrawCircle(SDKQpred.CastPosition, 10, Color.Blue, 10);
                }
                if (!FSQpred.CastPosition.IsZero)
                {
