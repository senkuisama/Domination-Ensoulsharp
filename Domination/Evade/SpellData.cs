...
namespace DaoHungAIO.Evade
{
    ...
    using DominationAIO.DominationAIO.Common;
        ...
        public int Radius
        {
            get
            {
                return !AddHitbox
                    ...
                    : EvadeManager.SkillShotsExtraRadius + _radius + (int)GameObjects.AllyHeroes.FirstOrDefault(x => x.Distance(ObjectManager.Player) < DominationAIO.Common.Champion.E.Range).BoundingRadius;
            }
            set { _radius = value; }
        }
