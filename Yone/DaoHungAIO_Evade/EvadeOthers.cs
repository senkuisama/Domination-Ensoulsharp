    ...
    internal class EvadeOthers
    {
                                ...
                                1000 <= 300)
                            {
...

                                {
                                    if (EvadeTargetManager.Menu["whitelist"][
                                            ally.CharacterName.ToLower()].GetValue<MenuBool>().Enabled)
                                    {
        ...
        private static void OnProcessSpellCast(AIBaseClient sender, AIBaseClientProcessSpellCastEventArgs Args)
        {
                ...
                if (ally != null)
                {
                    ...
                    if (EvadeTargetManager.AttackMenu["Brian.EvadeTargetMenu.Turret"].GetValue<MenuBool>().Enabled)
                    {
                        if ( ally.IsAlly)
                        {
                            if (ObjectManager.Player.CharacterName == "Janna" ||
                ...
                if (!sender.IsMinion())
                {
                    if (ally.IsAlly)
                    {
                        if (Args.SData.Name.Contains("BasicAttack") &&
                            EvadeTargetManager.AttackMenu["Brian.EvadeTargetMenu.BAttack"].GetValue<MenuBool>().Enabled &&
                            ally.HealthPercent <=
                ...
                if (ally != null)
                {
                        ...
                        if (ally.IsAlly)
                        {
...

                            {
                                   ...
                                   DominationAIO.Common.Champion.E.Range)
                                {
                                    ...
                                    if (
                                        EvadeTargetManager
                                            .AttackMenu["Brian.EvadeTargetMenu.Minion"].GetValue<MenuBool>().Enabled && ally.HealthPercent <=
                                        EvadeTargetManager
                    ...
                    if (Args.SData.Name.Contains("crit")  &&
                      EvadeTargetManager.AttackMenu["Brian.EvadeTargetMenu.CAttack"].GetValue<MenuBool>().Enabled
