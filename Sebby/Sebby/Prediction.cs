...
namespace Sebby
{
    ...
    public class PredictionInput
    {
        ...
        {
            EnsoulSharp.SDK.CollisionObjects.Minions, EnsoulSharp.SDK.CollisionObjects.YasuoWall
        };
        ...
        ///     The skillshot type.
        /// </summary>
        public SpellType Type = SpellType.Line;
    ...
    public static class Prediction
    {
        ...
        public static PredictionOutput GetPrediction(this Spell spell,
            ...
            CollisionObjects[] CollisionObjects = null
            )
        {
            var SpellInput = new PredictionInput
            {
                ...
                CollisionObjects = (CollisionObjects ?? new CollisionObjects[1]),
                Delay = spell.Delay,
                Radius = spell.Width,
        ...
        internal static PredictionOutput GetPositionOnPath(PredictionInput input, List<Vector2> path, float speed = -1)
        {
            ...
            {
                var d = tDistance;
                if (input.Type == SpellType.Line || input.Type == SpellType.Line)
                {
                ...
                for (var i = 0; i < path.Count - 1; i++)
                {
                    ...
                    var sol = VectorMovementCollision(a, b, speed, input.From.ToVector2(), input.Speed, tT);
                    var t = (float)sol[0];
                    ...
                    if (pos.IsValid() && t >= tT && t <= tT + tB)
                    {
                        ...
                        if (input.Type == SpellType.Line && false)
                        {
